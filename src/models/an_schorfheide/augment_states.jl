"""
```
augment_states{T<:AbstractFloat}(m::AnSchorfheide, TTT::Matrix{T}, RRR::Matrix{T}, CCC::Matrix{T})
```
...
"""
function augment_states(m::AnSchorfheide, TTT::Matrix{T}, RRR::Matrix{T}, CCC::Vector{T}) where T<:AbstractFloat
    return TTT, RRR, CCC
end
