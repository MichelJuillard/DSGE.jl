...
"""
function forecast_block_inds(m::AbstractModel, input_type::Symbol; subset_inds::UnitRange{Int64} = 1:0)
...
"""
function transplant_forecast(history::Matrix{T},
                             forecast::Matrix{T}, last_hist_period::Int) where T<:AbstractFloat
