...
- `block_inds::UnitRange{Int64}`: indices of the current block (already indexed by
  `jstep`) to be read in. Only used in second method

### Keyword Arguments

- `subset_inds::UnitRange{Int64}`: indices specifying the subset of draws to be read
...
function load_draws(m::AbstractModel, input_type::Symbol, block_inds::UnitRange{Int64};
                    verbose::Symbol = :low)
...
- `subset_inds::UnitRange{Int64}`: indices specifying the draws we want to use. If a
